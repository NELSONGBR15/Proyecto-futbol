		...
		function cargar(div, desde)
{
	...
	document.getElementById('cbox').innerHTML= '<img src="./images/loading.gif"style="margin-left:500px;margin-top:10px;">';
     $(div).load(desde);
     ...
     <div id="Logo">
	  ...
	  <td><input type="reset" value="borrar"/></td>
        ...
        <ul class="clsClearFixSub">
          <li class="clsActive"><a style="cursor:pointer;" onclick="cargar('#cbox', './contindex.php')">Inicio</a></li>
          <li><a style="cursor:pointer;" onclick="cargar('#cbox', './contquienes_somos.php')">Quienes somos</a></li>
          <li><a style="cursor:pointer;" onclick="cargar('#cbox', './contgaleria.php')">Galería</a></li>
          <li><a style="cursor:pointer;" onclick="cargar('#cbox', './contestatutos.php')">Estatutos</a></li>
        </ul>
      </div>
    </div>
    <div id="content">
