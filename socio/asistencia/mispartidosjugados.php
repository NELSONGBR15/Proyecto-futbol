...
<div id="topimg">
  ...
  <div id="maincontent">
	...
	<div id="identificacion">
	  <a href="../../index.php?desconectar=1" >Desconectar</a>
        ...
        <ul class="clsClearFixSub">
          ...
          <li class="clsActive"><a href="./asistencia.php"><img src="../../images/socio/3.png"/>Asistencia</a></li>
	...
	<ul class="asistencia">
	<p></p>
	<li><a  style="cursor:pointer;" onclick="cargar('#con', './miultimopartido.php')">Mi último partido</a></li>
	<li><a  style="cursor:pointer;" href="./mispartidosjugados.php">Mis partidos jugados</a></li>
	</ul>
	</div>	 
	...
	<div id="con">
	<?php include ('./consultatodospartidos.php'); ?>
	</div>
