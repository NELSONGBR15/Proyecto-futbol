...
function Pagina(nropagina){
 ...
 ajax.open("GET", "./consultatodospartidos.php?a=1&pag="+nropagina);
  ...
  $PagAct=1;
	...
	<?php
					...
					$instruccion = "SELECT i.usuario,i.golam, i.roam, i.amam, s.nombre, s.apellidos, s.posicion, i.color
									...
									AND color = 'am' AND i.fecha<='".temporadamayor($temporada['fecha'])."/06/30' AND i.fecha>='".temporadamenor($temporada['fecha'])."/09/01'
					...
					$instruccion = "SELECT i.usuario,i.golaz, i.roaz, i.amaz, s.nombre, s.apellidos, s.posicion, i.color
									...
									LEFT JOIN socio s ON i.usuario = s.usuario
									WHERE fecha = '".$resultado['fecha']."'
									AND color = 'az' AND i.fecha<='".temporadamayor($temporada['fecha'])."/06/30' AND i.fecha>='".temporadamenor($temporada['fecha'])."/09/01'
									ORDER BY posicion ASC";
...
<?php	
	...
	include ('../../php/conexion.php');
					...
					FROM incidencias
					WHERE fecha = '".$resultado['fecha']."'
					AND color = 'az' AND fecha<='".temporadamayor($temporada['fecha'])."/06/30' AND fecha>='".temporadamenor($temporada['fecha'])."/09/01'
					GROUP BY color";
	...
	include ('../../php/conexion.php');
					...
					FROM incidencias
					WHERE fecha = '".$resultado['fecha']."'
					AND color = 'am' AND fecha<='".temporadamayor($temporada['fecha'])."/06/30' AND fecha>='".temporadamenor($temporada['fecha'])."/09/01'
					GROUP BY color";
