...
<div id="topimg">
  ...
  <div id="maincontent">
	...
	<div id="identificacion">
	  <a href="../../index.php?desconectar=1" >Desconectar</a>
        ...
        <ul class="clsClearFixSub">
          ...
          <li class="clsActive"><a href="./tarjetas.php"><img src="../../images/socio/4.png"/>Tarjetas</a></li>
	...
	<ul class="tarjetas">
	<p></p>
	<li><a  style="cursor:pointer;" onclick="cargar('#con', './mistarjetas.php')">Mis tarjetas</a></li>
	<li><a  style="cursor:pointer;" onclick="cargar('#con', './todastarjetas.php')">Todas las tarjetas</a></li>
	</ul>
	</div>	 
